...
public:
  ...
  // Called by Cubism:
  void _apply_bc(const cubism::BlockInfo& info, const double t = 0, const bool coarse = false) override
  {
...
using ScalarLab     = cubism::BlockLabMPI<BlockLabDirichlet  <ScalarBlock, std::allocator>,ScalarGrid>;
